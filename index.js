...
const SPREADSHEET_ID = '1YqsL0Z3w26TsjxCShcv8YVY89kbgb8Y70MqvEJ3bhX0'; // L'ID de ta feuille Google Sheets
const RANGE = 'bdd!A2:AS220'; // La plage que tu veux lire (par exemple : 'Sheet1!A1:C10')
