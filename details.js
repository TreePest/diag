...
const formURL = `https://docs.google.com/forms/d/e/1FAIpQLScxHYJJopAHmSW0eU-v_S8idVS89GT-6fmicjztlj3o5dliAw/viewform?usp=pp_url&entry.1201042309=${encodeURIComponent(`${row[1]} ${row[2]}`)}`;
