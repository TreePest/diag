...
`;
    ...
    detailsContainer.innerHTML = `
        ...
        <div class="detail-item">
            ...
            <p><a href="${row[40]}" target="_blank" rel="noopener noreferrer" title="Consulter la page MycoBank"><img src="assets/icons/mycobank.png" alt="Mycobank" class="icon-link"></a></p>
            <p><a href="${row[41]}" target="_blank" rel="noopener noreferrer" title="Consulter la page Wikipédia"><img src="assets/icons/wiki.png" alt="Wikipédia" class="icon-link"></a></p>
